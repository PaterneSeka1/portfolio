...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      title: "Trello Clone",
      description:
        "A task management app inspired by Trello, built with React Native.",
    ...
    },
    {
      title: "Showtime",
      description:
        "Using API rotten tomatoes to display movies and series ratings. ",
      tech: ["NestJS", "Prisma"],
